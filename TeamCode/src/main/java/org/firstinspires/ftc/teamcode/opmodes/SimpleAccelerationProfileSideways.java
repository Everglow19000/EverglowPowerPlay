...
@TeleOp(name = "SimpleAccelerationProfileSideways", group = ".Main")
public class SimpleAccelerationProfileSideways extends LinearOpMode {
	@Override
	public void runOpMode() {
		...
		waitForStart();
		drivingSystem.driveSidewaysByProfile(accelerationProfile);
